...
./oemparts taxonomy-sync                                # Pull latest Y/M/M from eBay (incremental refresh)
./oemparts taxonomy-sync --all                          # Full refresh of all Y/M/M data (slow, use for cold start)
